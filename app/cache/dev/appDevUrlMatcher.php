...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Planning\\UserBundle\\Controller\\PlanningController::accueilAction',  '_route' => 'index',);
        }

        // home
        if ($pathinfo === '/Accueil') {
            return array (  '_controller' => 'Planning\\UserBundle\\Controller\\PlanningController::accueilAction',  '_route' => 'home',);
        }
