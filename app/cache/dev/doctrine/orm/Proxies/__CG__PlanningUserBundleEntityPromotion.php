 ...
 */
class Promotion extends \Planning\UserBundle\Entity\Promotion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function getIdpromotion()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdpromotion();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdpromotion', array());
    ...
    public function setNumPromotion($numPromotion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumPromotion', array($numPromotion));

        return parent::setNumPromotion($numPromotion);
    }
