 ...
 */
class Professeur extends \Planning\UserBundle\Entity\Professeur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function getIdprofesseur()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdprofesseur();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdprofesseur', array());

        return parent::getIdprofesseur();
    }
